...
class Lambda
{
    ...
    public static void main(String args[])
    {
        ...
        //FuncInter2 name = (String x) -> "tamtattoucht" + x;
        ...
        /*System.out.println("le string de la fonction est la "+ sobj.name(TAMTATTOUCHT));*/
       FuncInter2 fobj = message ->System.out.println("Hello " + message);
        fobj.sayMessage("zelmad from tamtattoucht");
    }
}